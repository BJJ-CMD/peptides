      ...
      <div className="h-[280px] overflow-y-auto rounded-lg border border-border bg-muted/30 p-4 text-sm leading-relaxed text-foreground/90">
        <div className="space-y-4">
          <section>
            ...
            <p>
              This Disclaimer applies to the use of https://pureaminos.org/ (&ldquo;Website&rdquo;), any products purchased from Pure Aminos (&ldquo;Company&rdquo;, &ldquo;We&rdquo;, &ldquo;Us&rdquo;, &ldquo;Our&rdquo;), and any information provided on or through the Website.
            </p>
            <p className="mt-2">
          ...
          <section>
            ...
            <p>Information on https://pureaminos.org/ is provided for educational and informational purposes only.</p>
