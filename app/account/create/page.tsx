        ...
        <div className="animate-in fade-in zoom-in-95 duration-300">
          <div className="rounded-2xl border border-slate-100 bg-white px-6 py-12 text-center shadow-[0_8px_40px_-12px_rgba(15,23,42,0.1)] sm:px-10">
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-600">
              Thanks — we&apos;ll confirm your account details shortly. You can keep browsing while we finish setup.
            </p>
            <Button
              type="button"
    ...
    <main className="mx-auto flex w-full max-w-md flex-col px-4 pb-16 pt-8 sm:px-6 sm:pb-24 sm:pt-12">
      <div className="animate-in fade-in slide-in-from-bottom-2 duration-500">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-slate-600 sm:text-base">Phone and password — quick and secure.</p>
        </div>
        ...
        >
          ...
          <p className="mt-6 text-center text-sm text-slate-600">
            ...
            <Link href="/account/sign-in" className="font-medium text-[#14B8A6] underline-offset-4 hover:underline">
              Sign in
            </Link>
          </p>
        </form>
